...
<div id="main" class="clear">
    ...
    <form action="../catalogo" method="post" id="myform">
        ...
        <div class="tableRow">
            <p>Nome:</p>
            <p><input type="text" name="nome" value="" required pattern="[A-Za-z0-9\s]+" title="Solo lettere e numeri"></p>
        </div>
        <div class="tableRow">
            <p>Descrizione:</p>
        ...
        <div class="tableRow">
            <p>Iva:</p>
            <p><input type="text" name="iva" value="" required pattern="\d+(\.\d{1,2})?" title="Formato numerico decimale, ad esempio 10 o 10.00"></p>
        </div>
        <div class="tableRow">
            <p>Prezzo:</p>
            <p><input type="text" name="prezzo" value="" required pattern="\d+(\.\d{1,2})?" title="Formato numerico decimale, ad esempio 10 o 10.00"></p>
        </div>
        <div class="tableRow">
            <p>Data:</p>
